'''
Current clamp demo using Allen Brain's model 473862496.
...
from neuron473862496 import Neuron473862496
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473862496(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473862496; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-94.9662704468)
        h.fcurrent()
